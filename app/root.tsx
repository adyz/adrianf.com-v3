      ...
      <footer className="text-center pb-4">
        ...
        <div className="text-colorLightBrown">
          ...
          <p className="text-sm m-0">
              Developed on <a target="_blank" title="Remix" rel="noopener noreferrer" href="https://www.remix.run">
              ...
              </a> and styled with <a target="_blank" title="Tailwind CSS" rel="noopener noreferrer" href="https://tailwindcss.com/">
