export default function VectorCharacter() {
    return (
        <svg width="241" height="289" viewBox="0 0 241 289" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path d="M106.5 61.6667L114.5 73.3542L121.5 66.5L109.5 47.5L106.5 61.6667Z" fill="#F5EFB9" stroke="#A1854D" />
            ...
            <path d="M89.5 40.5L92.6818 49.5L96.5 45.2647" stroke="#A1854D" />
            <path d="M101.967 51.2586L108.5 44.5L102.589 54.6379L94.5 58.5L101.967 51.2586Z" fill="white" stroke="#A1854D" />
            ...
            <circle cx="217.897" cy="278.307" r="1" transform="rotate(-47.9307 217.897 278.307)" fill="#795A5A" />
            <path d="M216.198 274.219L218.788 275.356" stroke="#795A5A" />
            <circle cx="219.164" cy="275.41" r="1" transform="rotate(-47.9307 219.164 275.41)" fill="#795A5A" />
            <path d="M217.466 271.322L220.056 272.459" stroke="#795A5A" />
            <circle cx="220.432" cy="272.513" r="1" transform="rotate(-47.9307 220.432 272.513)" fill="#795A5A" />
            <path fill-rule="evenodd" clip-rule="evenodd" d="M84 53L93 53.5L106 41L108 31L115 42L109.5 61.5L92.5 64.5L84 53ZM93 57.5L94.5 60L104 55.5L110.5 44L109 42L93 57.5Z" fill="#E1DCAD" />
        </svg>
