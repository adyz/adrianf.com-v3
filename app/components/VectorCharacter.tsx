export default function VectorCharacter() {
    return (
        <svg width="241" height="289" viewBox="0 0 241 289" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path fillRule="evenodd" clipRule="evenodd" d="M84 53L93 53.5L106 41L108 31L115 42L109.5 61.5L92.5 64.5L84 53ZM93 57.5L94.5 60L104 55.5L110.5 44L109 42L93 57.5Z" fill="#E1DCAD" />
        </svg>
